...
namespace TripClient
{
    public partial class MainApplication : Form, ITripObserver
    {
        ...
        public void SetUtilizator(Utilizator utilizator)
        {
            ...
            LoadSecondGridView();
            LoadComboBoxes();
            this.FormClosing += (sender, args) => LogOutUser();
        }
        ...
        {
            var listaExcursiiFiltrate = _serviceApplication.GetExcursiiByFilter(_obiectiv, TimeSpan.Parse(_deLa), TimeSpan.Parse(_panaLa));
            ...
            // DA CEVA AICI NU MERGE 
            // CA TEORETIC AR TRB SA COLOREZE SI IN AL DOILEA TABEL DA NU O FACE
        ...
        private void buttonRezerva_Click(object sender, EventArgs e)
        {
            ...
            // var rezervare =_serviceApplication.SaveRezervare(idExcursie, numeClient, numarTelefon, numarBilete);
            // if (rezervare.HasValue)
            // {
            //     ClearForm();
            //     ReloadMainGridView();
            //     ReloadSecondGridView();
