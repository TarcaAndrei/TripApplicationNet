...
namespace TripClient
{
    public partial class MainView : Form
    {
        ...
        private void buttonLogin_Click(object sender, EventArgs e)
        {
            ...
            //
            // var utilizator = clientOpt.Value;
            // if (_listaUseriLogati.Contains(utilizator.Id))
            // {
            //     MessageBox.Show("Eroare", "User logat deja");
            //     return;
            // }
            // CreateNewWindowPersoana(utilizator);
        }

        // private void CreateNewWindowPersoana(Utilizator utilizator)
        // {
        //     _listaUseriLogati.Add(utilizator.Id);
        //     var userStage = new MainApplication(_serviceApplication, utilizator);
        //     userStage.FormClosed += (sender, args) => LogOutUser(utilizator.Id);
        //     userStage.Show();
        //
        // }
